            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div id="login" class="pull-right">
                        ...
                        <dnn:USER ID="dnnUser" runat="server" LegacyMode="false" ShowAvatar="false" ShowUnreadMessages="false"/>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        <main role="main">
            ...
            <div id="mainContent-inner">
                ...
                <div class="row dnnpane">
                    <div id="P2_25_1" class="col-md-6 spacingTop" runat="server"></div>
                    <div id="P2_75_2" class="col-md-6 spacingTop" runat="server"></div>
                </div>
