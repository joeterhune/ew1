<%@ Control Language="vb" Inherits="AWS.Modules.Injunctions.AddUser" CodeFile="AddUser.ascx.vb" AutoEventWireup="false" Explicit="True" %>
...
<div class="dnnForm dnnClear">
    ...
    <ul class="dnnActions dnnClear">
        ...
        <li>
            <asp:HyperLink ID="lnkCancel" runat="server" class="dnnSecondaryAction" Text="Return" /></li>
                <li class="pull-right">
