<%@ Page Language="VB" AutoEventWireup="false" CodeFile="JudgeView.aspx.vb" Inherits="AWS.Modules.Injunctions.JudgeView" %>

<%@ Register Assembly="Atalasoft.dotImage.WebControls" Namespace="Atalasoft.Imaging.WebControls" TagPrefix="cc1" %>
<%@ Register TagPrefix="bzb" TagName="Zooming" Src="~/DesktopModules/AwsModules/Injunctions/controls/ZoomingControl.ascx" %>
<%@ Register TagPrefix="nb" TagName="Navigation" Src="~/DesktopModules/AwsModules/Injunctions/controls/NavigationControl.ascx" %>
...
<![endif]-->
    ...
    <title>Review Injunctions</title>
</head>
<body>
        ...
        <div id="container" runat="server">
                    ...
                    <ul class="main_ul">
                        ...
                        <li>
                            <menu class="sub" label="Annotations"><asp:ImageButton class="button" ID="Button_Freehand" runat="server" ImageUrl="~/Images/Pen.png"
                                ...
                                <asp:ImageButton class="button" ID="Button_Delete" runat="server" ImageUrl="~/Images/Delete-blue.png"
                        ...
                        <li>
                            <menu class="sub" label="Sign">
                                <asp:ImageButton class="button" ID="Button_SignStamp" runat="server" ImageUrl="~/Images/rubber stamp.png"
                        ...
                        <li>
                            <menu class="sub" label="Initial">
                                <asp:ImageButton class="button" ID="Button_InitialStamp" runat="server" ImageUrl="~/Images/rubber stamp-i.png"
                        ...
                        <li>
                            <menu class="sub" label="CheckMark">
                                <asp:ImageButton class="button" ID="Button_CheckMark" runat="server" ImageUrl="~/Images/check.png"
                        ...
                        <li>
                            <menu class="sub" label="Stamp">
                                <asp:ImageButton class="button" ID="Button_Date" runat="server" ImageUrl="~/Images/calendar.png"
                        ...
                        <li>
                            <menu class="sub" label="Stamp">
                                ...
                                <asp:ImageButton class="button" ID="Button_PS" runat="server" ImageUrl="~/Images/ps.png"
                        ...
                        <li>
                            <menu class="sub" label="Save Text">
                                <asp:ImageButton class="button" ID="Button_Text" runat="server" ImageUrl="~/Images/Text.png"
                                ...
                                <asp:ImageButton class="button" ID="SaveText" runat="server" ImageUrl="~/Images/SaveText.png"
                                    ToolTip="Save text annotations" Height="24px" Width="24px" OnClientClick="GetTextFromAnnotation(); return false;" />
                                <asp:ImageButton class="button" ClientIDMode="Static" ID="showCustomTextList" runat="server" ImageUrl="~/Images/add-list.png"
            ...
            <footer id="status" class="dnnForm dnnClear">
                <ul class="dnnActions dnnClear">
                    <li id="sb">
                        <asp:Button ID="cmdSave" runat="server" CssClass="dnnPrimaryAction" Text="Approve" OnClientClick="ApproveInjunction(); return false;" /></li>
                    <li id="rb">
                        <input id="txtReason" type="text" name="Reason" maxlength="250" placeholder="Reject Reason" />
                        <asp:Button ID="cmdReject" CssClass="dnnSecondaryAction" runat="server" CausesValidation="true" Text="Reject" OnClientClick="RejectInjunction(); return false;" /></li>
                    <li id="cb">
                        <asp:Button ID="cmdCancel" CssClass="dnnSecondaryAction" runat="server" CausesValidation="false" Text="Return to Signing Queue without Action" OnClientClick="CancelInjunction(); return false;" /></li>
                </ul>
