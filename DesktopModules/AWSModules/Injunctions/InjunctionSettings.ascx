<%@ Control Language="vb" Inherits="AWS.Modules.Injunctions.Settings" CodeFile="InjunctionSettings.ascx.vb" AutoEventWireup="false" %>
...
<div class="dnnForm dnnClear">
    ...
    <div class="dnnFormItem">
        <dnn:Label ID="lblSignedInjunctionRole" runat="server" ControlName="drpSignedInjunctionRole" Suffix=":"></dnn:Label>
        <asp:DropDownList ID="drpSignedInjunctionRole" runat="server"></asp:DropDownList>
    </div>
    <div class="dnnFormItem">
