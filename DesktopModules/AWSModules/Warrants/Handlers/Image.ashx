<%@ WebHandler Language="VB" Class="AWS.Modules.Warrants.SignatureImage" %>
...
Namespace AWS.Modules.Warrants
    Public Class SignatureImage
        ...
        Private Function GetImage(ByVal id As Integer) As Byte()
            Dim objWarrantImage As WarrantImage = ctl.GetFile(id)
            
            Dim imageData As Byte() = DirectCast(encryptor.DecryptStream(objWarrantImage.Bytes), Byte())
            Return imageData
