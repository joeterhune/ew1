...
Imports AWS.Modules.Notifications
Imports DotNetNuke
...
#Region "Methods"
        ...
        Private Sub BindData()
            ...
            Dim colNotifications As List(Of NotificationInfo) = nCtl.ListMyNotifications(UserId)
...
#Region "Event Handlers"
        ...
        Private Sub cmdUpdate_Click(ByVal sender As Object, ByVal e As EventArgs) Handles cmdUpdate.Click
            Try
                ...
                End With
                Dim colNotifications As List(Of NotificationInfo) = nCtl.ListConflictingNotifications(UserId, objNotification.StartDateTime, objNotification.EndDateTime)
