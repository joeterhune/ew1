<%@ Control Language="vb" Inherits="AWS.Modules.Warrants.EditJudge" CodeFile="EditJudge.ascx.vb" AutoEventWireup="false" Explicit="True" %>
...
<div class="dnnForm dnnClear">
    ...
    <div class="dnnFormItem labelnowidth">
        ...
        <asp:TextBox ID="txtDayStart" runat="server" MaxLength="10" CssClass="date"  autocomplete="off"/><span> to </span>
        <asp:TextBox ID="txtDayEnd" runat="server" MaxLength="10" CssClass="date"  autocomplete="off"/>
    </div>
