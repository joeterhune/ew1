<%@ Control Language="VB" AutoEventWireup="false" CodeFile="Toolbar.ascx.vb" Inherits="AWS.Modules.Warrants.Toolbar" %>
 <div id="rtoolbar" runat="server" class="btn-group" role="group" aria-label="Toolbar">
     ...
     <asp:HyperLink CssClass="btn btn-primary" ToolTip="Change the Status of a Document" Visible="false" ID="lnkStatus" runat="server"><em class='fa fa-bar-chart'></em> Change Status</asp:HyperLink>
     ...
     <asp:HyperLink CssClass="btn btn-primary" ToolTip="Manage Custom Text Values for Signing Documents" Visible="false" ID="lnkAnnotations" runat="server"><em class='fa fa-keyboard-o'></em> Manage Custom Text</asp:HyperLink>
     <asp:HyperLink CssClass="btn btn-success" ID="lnkUpload" ToolTip="Upload a New Document" runat="server"><em class='fa fa-upload'></em> Upload Document</asp:HyperLink>
